          ...
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <Button variant="outline" className={`transition-colors ${
                isDarkMode 
                  ? 'border-indigo-500 text-indigo-400 hover:bg-indigo-500 hover:text-white px-3' 
                  : 'border-indigo-500 text-indigo-600 hover:bg-indigo-500 hover:text-white px-3'
              }`}>
                Sign In
              </Button>
            </div>
